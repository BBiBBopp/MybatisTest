...
<body>
	<!-- 
		* 프레임워크
		...
		- 소프트웨어 개발의 입장에서는 공통으로 사용하는 라이브러리/개발도구/인터페이스 등을 의미
		
		* 왜 프레임워크를 쓰는가?
		- 현재 웹프로그래밍의 규모가 커지고 있음
		=> 거대하고 복잡도가 높은 프로젝트를 완성시키기 위해 많은 사람이 필요
		=> 그 개발자들이 "통일성"있게 "빠르고" "안정적"으로 개발하기 위한 도구로 프레임워크가 좋은 성과를 내고 있다.
		=> 생산성 향상에 도움이 된다.
		
		* 프레임워크의 특징
		- 자유롭게 성계하고 코딩하는 것이 아니라 프레임워크가 제공하는 가이드대로 설계하고 코드를 작성해야함(셋팅도)
		- 개발할 수 있는 범위가 정해져있음
